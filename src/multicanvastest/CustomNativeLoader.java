...
public class CustomNativeLoader {
    ...
    static private String crc(String nativeFile) {
        InputStream input = CustomNativeLoader.class.getResourceAsStream("/" + nativeFile);
        if (input == null) {
            return "wrongversion"; // fallback
        }
        CRC32 crc = new CRC32();
    ...
    static public boolean loadLibrary(String nativeFile32, String nativeFile64) {
        final String path = extractLibrary(nativeFile32, nativeFile64);
    ...
    static public String extractLibrary(String native32, String native64) {
        ...
        try {
            ...
            InputStream input = CustomNativeLoader.class.getResourceAsStream("/" + nativeFileName);
            if (input == null) {
                return null;
            }
            nativesDir.mkdirs();
